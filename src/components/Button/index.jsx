    ...
    <button
      ...
      className={clsx(
        ...
        },
        {
          ...
          'bg-transparent border-2 border-sky-500 text-sky-500 hover:bg-sky-500 hover:text-white': variation === 'border' && !(loading || disabled),
          'bg-transparent border-2 bg-gray-100 border-sky-300 text-sky-300 pointer-events-none': variation === 'border' && (loading || disabled),
